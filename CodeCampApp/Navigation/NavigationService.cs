...
namespace CodeCampApp.Navigation
{
    ...
    public class NavigationService : INavigationService
    {
        ...
        public void RegisterPageModels(Assembly asm)
        {
            ...
            DebugWriteDictionary(_pageModelPageDictionary, "PageModels -> Pages");
        }
        ...
        private void PrintModalStackDepth(string stackChange)
        {
            ...
            DebugWriteList(stackList, $"Modal Stack after {stackChange}");
        }
        ...
        private void PrintNavigationStackDepth(string stackChange)
        {
            ...
            DebugWriteList(stackList, $"Navigation Stack after {stackChange}");
        }
